...
class AutomationGUI:
    ...
    def create_widgets(self):
        ...
        sut_group = ttk.LabelFrame(settings_frame, text="SUT Remote Connection Settings", padding="10")
        ...
        vision_group = ttk.LabelFrame(settings_frame, text="Vision System + FSM Thinking - WIP", padding="10")
        vision_group.pack(fill=tk.X, pady=(0, 10))
        
        # Vision System URL
        url_row = ttk.Frame(vision_group)
        url_row.pack(fill=tk.X, pady=(0, 10))
        ttk.Label(url_row, text="Vision System Server URL:").pack(side=tk.LEFT, padx=(0, 5))
        ...
        ttk.Label(game_path_row, text="Game Path:").pack(side=tk.LEFT, padx=(0, 5))
        path_entry_frame = ttk.Frame(game_path_row)
        path_entry_frame.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 5))
        ttk.Entry(path_entry_frame, textvariable=self.game_path).pack(side=tk.LEFT, fill=tk.X, expand=True)
        ttk.Button(game_path_row, text="Browse...", command=self.browse_game_path).pack(side=tk.LEFT)
        
        # Config File
        config_row = ttk.Frame(game_config_frame)
        config_row.pack(fill=tk.X, pady=(0, 10))
        ttk.Label(config_row, text="Game Config File:").pack(side=tk.LEFT, padx=(0, 5))
...
#         # ---- ROW 5: Config Type Info ----
#         config_info_frame = ttk.Frame(settings_frame)
#         config_info_frame.grid(row=5, column=0, columnspan=6, sticky=tk.W+tk.E, padx=5, pady=5)
#         ttk.Label(config_info_frame, text="Config Type:").pack(side=tk.LEFT, padx=5)
#         self.config_type_label = ttk.Label(config_info_frame, text="No config loaded", foreground="gray")
#         self.config_type_label.pack(side=tk.LEFT, padx=5)
